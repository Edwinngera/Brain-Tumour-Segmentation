    ...
    def save_patient(self, reg_norm_n4, patient_num):
        ...
        if reg_norm_n4 == 'norm':
            for slice_ix in xrange(155):
                ...
                io.imsave('/media/hrituraj/New Volume/BRATS2015_Training/BRATS2015_Training/Norm_PNG/{}_{}.png'.format(patient_num,
                          slice_ix), strip)
...
def save_labels(labels):
    ...
    for label_idx in progress(xrange(len(labels))):
        ...
        for slice_idx in xrange(len(slices)):
            io.imsave('/media/hrituraj/New Volume/BRATS2015_Training/BRATS2015_Training/HGG/Labels/{}_{}L.png'.format(label_idx, slice_idx), slices[slice_idx])
...
if __name__ == '__main__':
    ...
    #save_labels(labels)
    patients = glob('/media/hrituraj/New Volume/BRATS2015_Training/BRATS2015_Training/HGG/**')
