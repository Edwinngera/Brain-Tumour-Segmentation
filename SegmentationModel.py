...
class SegmentationModel(object):
    ...
    def fit_model(self, X_train, X5, y_train, X5_train = None, save = True):
        ...
        checkpointer = ModelCheckpoint(filepath="/media/hrituraj/New Volume/BRATS2015_Training/BRATS2015_Training/bm_{epoch:02d}-{val_loss:.2f}.hdf5", verbose=1)
...
if __name__ == '__main__':
    ...
    X = np.load('/media/hrituraj/New Volume/BRATS2015_Training/BRATS2015_Training/X.npy')
    X5 = np.load('/media/hrituraj/New Volume/BRATS2015_Training/BRATS2015_Training/x.npy')
    y = np.load('/media/hrituraj/New Volume/BRATS2015_Training/BRATS2015_Training/y.npy')
